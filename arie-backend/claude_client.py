    ...
    return {
        "sections": {
            ...
            "ownership_and_control": {
                ...
                "control_statement": "John Smith exercises effective control as majority shareholder (85%) and is the sole UBO. The remaining 15% is held by Jane Doe, who also serves as a director. No shareholder agreements or special voting arrangements were disclosed that would alter effective control.",
                "content": "The entity operates a simple, single-tier corporate structure with no intermediate holding entities, nominee arrangements, or bearer shares in issue. UBO: John Smith — 85% direct shareholding, British national, resident in the United Kingdom, not a PEP. Director 1: Jane Doe — Mauritian national, resident in Mauritius, not a PEP, also holds 15% shareholding. Director 2: Robert Lee — Singapore national, resident in Singapore, identified as a Politically Exposed Person (Foreign Government Official — Senior Trade Advisor, Singapore Ministry of Trade and Industry). Robert Lee holds no shareholding and exercises no ownership control, but his board position confers governance influence that warrants enhanced due diligence. The beneficial ownership chain was verified against the Mauritius Companies Division register via OpenCorporates. The register of directors and register of shareholders are mutually consistent. No discrepancies identified between declared and registered ownership."
            },
            "risk_assessment": {
                ...
                "sub_sections": {
                    ...
                    "ownership_risk": {
                        ...
                        "rating": "MEDIUM",
                        "content": "Beneficial ownership has been identified to natural person level through a single-tier structure, which is a positive indicator. However, one director (Robert Lee) has been identified as a PEP (Foreign Government Official — Senior Trade Advisor, Singapore Ministry of Trade and Industry). Although Robert Lee holds no direct ownership and his PEP status relates to a government advisory role rather than a position with direct control over public funds, his board position confers governance influence and introduces the potential for corruption or undue influence risk that FATF Recommendation 12 requires enhanced scrutiny for. The PEP does not exercise effective control (which rests with John Smith at 85%), partially mitigating this concern. Risk weighting factor: 0.25. Contribution to composite score: +13 points."
                    },
            ...
            "red_flags_and_mitigants": {
                ...
                "mitigants": [
                    "Robert Lee holds no ownership stake (0%) and does not exercise effective control, which rests with John Smith (85%). His PEP role is advisory rather than executive, reducing the likelihood of direct corruption exposure. PEP declaration and bank reference letter have been requested as conditions of approval.",
        ...
        "metadata": {
            ...
            "key_findings": [
                "Beneficial ownership traced to natural persons via single-tier structure — John Smith (85%, UK national) exercises effective control",
            ...
            "review_checklist": [
                ...
                "UBO chain mapped to natural person: John Smith (85%, UK national) — effective control confirmed",

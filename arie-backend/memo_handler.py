        ...
        "sections": {
                ...
                "sub_sections": {
                    ...
                    "business_risk": {
                        ...
                        "content": (
                            ...
                            + f"Business model plausibility was assessed by Agent 4 (Corporate Structure & UBO Mapping) in conjunction with Agent 5 (Compliance Memo). Risk weighting factor: 0.15."
                        )
                    },
                    "transaction_risk": {
            ...
            "ai_explainability": {
                ...
                "content": (
                    ...
                    + f"Decision pathway: Agent 1 (Identity & Document Integrity) -> Agent 2 (External Database Cross-Verification) -> Agent 3 (FinCrime Screening Interpretation) -> Agent 4 (Corporate Structure & UBO Mapping) -> Agent 5 (Compliance Memo). "
            ...
            "audit_and_governance": {
                ...
                "content": (
                    f"This compliance onboarding memo was generated by the Onboarda AI Compliance Engine (Agent 5: Compliance Memo Agent), version 2.1. "
                    f"All data inputs were validated through the 10-agent verification pipeline: "
                    f"Agent 1 (Identity & Document Integrity), Agent 2 (External Database Cross-Verification), "
                    f"Agent 3 (FinCrime Screening Interpretation), Agent 4 (Corporate Structure & UBO Mapping), "
                    f"Agent 5 (Compliance Memo). Monitoring agents: Agent 6 (Periodic Review Preparation), "
                    f"Agent 7 (Adverse Media & PEP Monitoring), Agent 8 (Behaviour & Risk Drift), "
                    f"Agent 9 (Regulatory Impact), Agent 10 (Ongoing Compliance Review). "
                    f"The supervisor module performs inter-agent consistency checking and contradiction detection. "

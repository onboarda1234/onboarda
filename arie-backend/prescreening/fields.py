...
SESSION_PRESCREENING_FIELD_MAP = {
    ...
    "f-volume-rationale": "volume_rationale_vs_business_size",
...
LEGACY_SESSION_PRESCREENING_FIELD_MAP = {
    ...
    "volumeRationale": "volume_rationale_vs_business_size",
    "volumeRationaleVsBusinessSize": "volume_rationale_vs_business_size",

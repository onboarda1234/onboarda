...
|---|---|---|---|---|
| dismissed | Valid | dismissed | Candidate for future migration | 3 |
...
| open | Valid | open, routed_to_edd | Candidate for future migration | 9 |
| resolved | Valid | resolved | Candidate for future migration | 1 |

...
| SRP-2 | Stale-report refresh pathway for pre-enrichment stored screening snapshots (governed re-screen; archive-first, adjudication guard, regulated archive table) | — | #784 | 🟢 PR open — approved 2026-07-17; 132 candidates; staged rollout: dry-run, then batch 1 incl. ARF-2026-920016, then fleet | — |

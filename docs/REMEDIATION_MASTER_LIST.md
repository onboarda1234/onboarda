...
| DCI-104 (re-run) | P12-5 / #716 + DCI-006 | All 3 v2.47 CHECK constraints still **ABSENT** on staging **+ 54 unindexed FKs**. *(Correction: the DCI-006 remediation SQL is NOT "on main" — it is landed for review as **[#739](https://github.com/onboarda1234/onboarda/pull/739)**.)* | 🟢 #739 (constraint-unblock SQL) · ⬜ 54-FK-index follow-up |

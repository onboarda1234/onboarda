...
| ID | Title | Sev | GitHub | Status | E |
|----|-------|:--:|:--:|----|:--:|
| SRP-0 | Verify stale-snapshot vs live-normalizer split (ARF-2026-920016; fresh-screen contrast; distinct-profile count of the 298 hits) — read-only | — | — | ⬜ ready — awaiting founder go | — |
...
| SRP-2 | Stale-report refresh pathway for pre-enrichment stored screening snapshots (governed re-normalize/re-screen) | — | — | ⬜ gated on SRP-0 findings | — |

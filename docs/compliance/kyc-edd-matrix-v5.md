# RegMind KYC/EDD Requirements Matrix — v5 (APPROVED TARGET STATE)

Canonical target configuration for back-office Enhanced Requirements and Document Verification Policies.
...
| PEP / adverse media context | pep_adverse_media_assessment | Adverse media assessment | Internal task | No | No | **RETIRED 2026-08-04** — superseded by automated ComplyAdvantage per-party adverse-media screening | Internal | No | No | Not portal-visible |
| PEP monitoring | pep_enhanced_monitoring_flag | Enhanced monitoring flag | Internal task | No | No | **RETIRED 2026-08-04** — superseded by the risk-based periodic review cadence | Internal | No | No | Not portal-visible |
